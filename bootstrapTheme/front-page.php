    ...
    <div id="carouselBswp" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
         ...
         $my_query_banner =  new WP_query($my_args_banner); ?>
          ...
          <?php if($my_query_banner->have_posts()): $banner = $banners[0]; $count = 0;  while($my_query_banner->have_posts()): $my_query_banner->the_post();?>
        

            <div class="carousel-item <?php $count++; if($count == 1): echo 'active'; endif;?>">
